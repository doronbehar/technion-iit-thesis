...
The piecewise fit results, described in subsection \ref{ssec:intro/SummarizedMeasurement}, can be plotted by the command line options \texttt{--show-fits} and \texttt{--show-regimes}. \texttt{--show-fits} simply plots the lines of the fits in addition to the raw measurements.
...
\hline
\texttt{mathieu.py}             & Implement a \texttt{Trap} class solving the Mathieu equations given, as described in subsection \ref{ssec:comp/mathieu}.                               & Can open figures \ref{fig:pure-mathieu-coefficients}, \ref{fig:pure-mathieu-fft}, \ref{fig:mathieu-stability} \& \ref{fig:mathieu-mass-dep}.Is also capable of exploring the dependence of $\{(a_i, q_i)\}$ solutions given $\beta_i$ in other ways. \\
\hline
...
% TODO: Get this figure, currently this is a stub copy, also, put it in a separate page.
\begin{figure}[h]
	\begin{center}
...
% TODO: Put this table in a landscape, separate page
\begin{table}[h]
