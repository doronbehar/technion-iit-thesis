...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth]{graphics/Yb-Cooling-Limit/T@Ti=10.pdf}
\end{figure}
\end{column}
...
% index a0abaaf..6ce0cb5 100755
% --- a/time-plot.py
% +++ b/time-plot.py
% @@ -111,8 +111,8 @@ class TimePlot(PlotterBase):
%                          # There is no real need for two labels for both time
%                          # parts, so we use a boolean switch here based on the
%                          # two possible parts of the simulation.
% -                        ", ".join(label_key)
% -                        if part == "cooling" else
% +                        ", ".join(label_key[:1])
% +                        if part == "cooling" and displayment_dict['linestyle'] == 'solid' else
%                          None
%                      ),
%                  )
%
