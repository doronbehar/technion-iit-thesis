...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% diff --git i/time-plot.py w/time-plot.py
% index 663ae3a..7f6307d 100755
% --- i/time-plot.py
% +++ w/time-plot.py
% @@ -108,6 +108,13 @@ class TimePlot(PlotterBase):
%                      markevery=0.25,
%                      # Set alpha=1 in contrast to alpha above
%                      markerfacecolor=displayment_dict['color'] + "ff",
% +                )
% +                self.ax.plot(
% +                    [],[],
% +                    color=displayment_dict['color'] + "{:02x}".format(
% +                        # Specify alpha here instead of the fraction
% +                        round(0.3 * 255)
% +                    ),
%                      # NOTE: Not using `alpha` parameter directly, in order to
%                      # use different alpha values for markers and lines.
%                      label=(
% @@ -117,7 +124,7 @@ class TimePlot(PlotterBase):
%                          ", ".join(label_key)
%                          # NOTE: A cool way to always make sure there will be a
%                          # label, generalized to any self.args.parts values.
% -                        if part == self.args.parts[0] else
% +                        if part == self.args.parts[0] and displayment_dict['marker'] == 'x' else
%                          None
%                      ),
%                  )
%
