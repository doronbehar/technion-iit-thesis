...
\begin{itemize}
    \item[$+$]<2-> Can deal with $N(N-1)$ Coulomb interactions in $\mathcal{O}(1)$ complexity using GPU.
...
$$\phi = \sum_{i\in\{x,y,z\}} x_i^2 \left(a_i + q_i \cos(2\pi f_\mathrm{rf} t)\right) \Rightarrow \ddot{x}_i = \left(\tilde{a}_i + 2\tilde{q}_i\cos(2\tau)\right) x_i$$
