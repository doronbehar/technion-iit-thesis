...
\only<1>{
\begin{figure}
    \centering\includegraphics[width=\linewidth]{graphics/Ramsey-scheme-short.pdf}
\end{figure}
}
\only<2>{
\begin{figure}
...
\only<3->{
\begin{figure}
    \centering\includegraphics[width=\linewidth]{graphics/Ramsey-Dissociation.pdf}
\end{figure}
}
\end{column}
...
\uncover<3->{\begin{figure}
    \centering
    \alt<3-9>{\includegraphics[width=\linewidth]{graphics/ion-trap-basics@effective.pdf}}{\includegraphics[width=\linewidth]{graphics/ion-trap-basics@effectiveNoX.pdf}}
...
\uncover<2->{Reminder: $$
    \mathbf{F}(\mathbf{v}) = \sum_\pm \frac{h \pi \Gamma \hat{k}}{\lambda} \cdot \frac{\pm\Omega^2/2}{\Gamma^2/4 + \Omega^2/2 + (\delta \mp \mathbf{k}\cdot\mathbf{v})^2}
$$}

\uncover<3->{Boltzmann: $\mathcal{P}(v) \propto \exp\left(-\frac{m v^2}{2 K_\mathrm{B}T}\right)$}

\uncover<4->{Overlap: $$
\int_{-\infty}^\infty\,\mathrm{d}v\exp\left(-\frac{m v^2}{2 K_\text{B} T}\right) |\mathbf{F}(v)|
$$}
\end{column}
...
\uncover<6->{Intuitively: $$\delta_\mathrm{opt} = \frac{\sqrt{K_\text{B} T/m}}{\lambda}$$}
...
\begin{frame}{Optimizing LASER for initial $T$}
    
\begin{figure}
\centering
\alt<4->{\includegraphics[width=\linewidth]{graphics/sympathetic-omega-dep@m=174@intensity.pdf}
}{\includegraphics[width=\linewidth]{graphics/sympathetic-omega-dep@m=174.pdf}
}
\end{figure}

\uncover<2->{\vspace{-2em}\tiny{\input{artifacts/sympathetic-omega-dep@parameters.tex}}}

\uncover<3->{\vspace{1em}$$\text{Bloch Equations: }
I = \frac{2\pi h c \Gamma}{3 \lambda^3} \cdot \left(\frac{\Omega}{\Gamma}\right)^2 \underset{\ce{Yb^+}}{\approx} \frac{1\mathrm{mW}}{\mathrm{mm}^2} \cdot \left(\frac{\Omega}{\Gamma}\right)^2
$$}
